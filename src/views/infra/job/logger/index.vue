<template>
  <doc-alert title="定时任务" url="https://doc.mirai.jp/job/" />
  <doc-alert title="异步任务" url="https://doc.mirai.jp/async-task/" />
  <doc-alert title="消息队列" url="https://doc.mirai.jp/message-queue/" />
